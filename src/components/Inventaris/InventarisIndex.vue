<template>
    <div class="container">
        <div class="card books">
            ...
            <div class="card-body">
                <router-link to="/inventaris/add" class='btn float-right'>Add Inventaris</router-link>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr v-for="inventaris in inventaris" :key="inventaris.id">
                                ...
                                <td><router-link :to="`/log?barang_id=${inventaris.Barang.id}&gudang_id=${inventaris.Gudang.id}&page=1&per_page=50`" class='btn'>Open Log</router-link></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
